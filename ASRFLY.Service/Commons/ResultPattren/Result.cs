...
namespace ASRFLY.Application.Commons.Result
{
    /// <summary>
    ...
    public class Result
    {
        ...
        /// </summary>
        public static Result Failure(Error error, Exception exception) => new Result(false, error, exception);
        ...
        public static Result<T> Failure<T>(Error error, Exception exception)
            => new Result<T>(default, false, error, exception);
